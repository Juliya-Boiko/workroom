    ...
    return (
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M11.5 3h.5l.322.02c4.7.39 8.415 4.19 8.678 8.98v.497a9.378 9.378 0 0 1-1.006 4.25A9.499 9.499 0 0 1 7.92 21.299l-.27-.117-1.575.574a3 3 0 0 1-3.78-1.63l-.065-.163a3 3 0 0 1 .01-2.077l.575-1.542-.114-.264a9.378 9.378 0 0 1-.695-3.212L2 12.499a9.498 9.498 0 0 1 5.25-8.492A9.38 9.38 0 0 1 11.5 3Zm.457 1.999h-.46a7.386 7.386 0 0 0-3.35.795A7.5 7.5 0 0 0 4 12.502a7.38 7.38 0 0 0 .793 3.347 1 1 0 0 1 .044.801l-.725 1.936a1 1 0 0 0 1.28 1.29l1.966-.716a1 1 0 0 1 .793.047A7.38 7.38 0 0 0 11.5 20a7.502 7.502 0 0 0 6.707-4.15A7.385 7.385 0 0 0 19 12.5l.002-.445a7.48 7.48 0 0 0-7.045-7.056Zm0 0h.001-.013.012ZM7 11a1 1 0 0 1 1-1h7a1 1 0 1 1 0 2H8a1 1 0 0 1-1-1Zm3 3a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2h-3Z"
          clipRule="evenodd"
        />
      </svg>
    );
